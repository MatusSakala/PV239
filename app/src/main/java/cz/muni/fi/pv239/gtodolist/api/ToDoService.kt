...
object ToDoService {
    ...
    val mockToDoList = listOf(
        ...
        ToDo(4, "DONE TODO", "volitelny dobrovolny popis for done todo", true),
        ...
        ToDo(8, "osme TODO aaaaaaa", "volitelny dobrovolny popisvolitelny dobrovolny popis volitelny dobrovolny popis volitelny dobrovolny popis" ),
